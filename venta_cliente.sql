...
CREATE TABLE `cliente` (
  ...
  KEY `cliente_persona_idx` (`idpersona`),
  CONSTRAINT `cliente_persona` FOREIGN KEY (`idpersona`) REFERENCES `persona` (`idpersona`) ON DELETE NO ACTION ON UPDATE NO ACTION
